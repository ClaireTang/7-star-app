	...
	<form class="content" @submit="toPay" report-submit="true">
				...
				<view class='img-list-item' v-if="item.is_select == true" v-for="(item, index) in products" :key="index">
					...
					<view class='img-list-item-r little-right'>
						<view class='little-right-t'>
							...
							<view class='goods-price'>{{ item.products.point_price || '0'}}积分</view>
						</view>
			...
			<view class='cell-group'>
				...
				<view class='cell-item'>
					...
					<view class='cell-item-ft cell-item-bd-block'>
						<view class="cell-ft-view red-price">{{ cartData.point_goods_amount || '0'}}积分</view>
		...
		<view class="button-bottom">
			<view class="button-bottom-c">
				...
				<view class="button-bottom-c-b">合计	<text class="red-price" style="margin-left:5upx;"> {{ cartData.point_amount || '0'}} 积分</text></view>
			</view>
			<button class='btn btn-square btn-b' hover-class="btn-hover2" form-type="submit" :disabled='submitStatus' :loading='submitStatus'>立即兑换</button>
		</view>
	</form>
</template>
